...
#define _DOVES_GPS_CONFIG_H
  ...
  //  every 1, 5, or 10 packets, if not sent defaults to every packet
  const PROGMEM  uint8_t GPGGAOn1[] = {0xB5, 0x62, 0x06, 0x01, 0x08, 0x00, 0xF0, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x28};
