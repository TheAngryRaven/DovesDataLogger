...
// Only real artwork lives here. The two "calculating" crossing frames used
// to sit alongside the bird as hand-stored 1 KB bitmaps, but they were pure
// 16 px block patterns — they are now generated at draw time by the
// host-tested crossing_pattern unit (2048 B of flash reclaimed, output
// proven byte-identical by crossing_pattern_test.cpp).
